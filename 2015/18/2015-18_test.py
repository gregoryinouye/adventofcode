...
def test_part_one_with_example_input(test_example_input):
    assert solution.part_one(test_example_input, steps=4) == 4
...
def test_part_two_with_example_input_2(test_example_input_2):
    assert solution.part_two(test_example_input_2, steps=5) == 17
