...
const checkIntersect = (coord, steps) => {
  if (map.has(coord)) {
    const [x, y] = coord.split(':');
    intersect.push({ x, y, steps: map.get(coord) + steps });
  }
};
